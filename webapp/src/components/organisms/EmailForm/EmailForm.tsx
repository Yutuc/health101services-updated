  ...
  return (
    <div className="px-10">
      <div className="flex justify-center md:text-3xl sm: text-xl">
        <h1 className="text-secondaryBlue font-bold">Connect with us</h1>
      </div>
      <div className="flex w-full justify-center">
        <h1 className="md:text-2xl sm:text-xl md:font-normal sm: font-bold">
          (204)-880-1009
        </h1>
      </div>
      ...
      <div>
        <form onSubmit={sendEmail}>
          <input
            className="flex w-full h-50 pb-5 pl-1 mb-3 text-black font-bold border-2 border-black"
            type="text"
